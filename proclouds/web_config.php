<?php	
require_once(dirname(__FILE__).'/inc/config.inc.php');IsModelPriv('web_config');
...
$config_en_cache  = PHPMYWIND_EN.'/include/config.cache.php';
...
{
	global $dosql, $config_cache, $config_en_cache, $gourl;
