...
<div class="homeHeader">
	<div class="header"><span class="title">首页 欢迎您：<?php echo $_SESSION['admin'];?></span><a href="javascript:location.reload();" class="reload">刷新</a></div>
</div>
...
<div class="homeCopy"> 敬请您将在使用中发现的问题或者不适提交给我们，以便改进 <a href="javascript:;" target="_blank" class="feedback">点击提交反馈</a> | <a href="help.php" class="doc">开发帮助</a> </div>
<?php
