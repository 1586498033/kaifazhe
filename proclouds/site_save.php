<?php	
require_once(dirname(__FILE__).'/inc/config.inc.php');IsModelPriv('site');
...
if($action == 'add')
{
	...
	if($dosql->ExecNoneQuery($sql))
	{
		...
		INSERT INTO `#@__webconfig` VALUES('$newsiteid','cfg_author_$site_key','网站作者','0','string','ProCloud Team','4');
		INSERT INTO `#@__webconfig` VALUES('$newsiteid','cfg_generator_$site_key','程序引擎','0','string','ProCloud','5');
		...
		INSERT INTO `#@__webconfig` VALUES('$newsiteid','cfg_copyright_$site_key','版权信息','0','bstring','Copyright © 2010 - 2013 ProCloud All Rights Reserved','8');
