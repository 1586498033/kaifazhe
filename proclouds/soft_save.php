<?php	
require_once(dirname(__FILE__).'/inc/config.inc.php');IsModelPriv('soft');
//初始化参数
$tbname = '#@__soft';
$gourl  = 'soft.php';
...
if($action == 'add')
{
	...
	$sql = "INSERT INTO `$tbname` (siteid, classid, parentid, parentstr, mainid, mainpid, mainpstr, title, colorval, boldval, flag, filetype, softtype, language, accredit, softsize, unit, runos, website, demourl, dlurl, source, author, linkurl, keywords, description, content, picurl, picarr, orderid, hits, downloads, posttime, checkinfo {$fieldname}) VALUES ('$cfg_siteid', '$classid', '$parentid', '$parentstr', '$mainid', '$mainpid', '$mainpstr', '$title', '$colorval', '$boldval', '$flag', '$filetype', '$softtype', '$language', '$accredit', '$softsize', '$unit', '$runos', '$website', '$demourl', '$dlurl', '$source', '$author', '$linkurl', '$keywords', '$description', '$content', '$picurl', '$picarr', '$orderid', '$hits', '$downloads', '$posttime', '$checkinfo' {$fieldvalue})";
