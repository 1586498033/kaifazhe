...
<form name="form" id="form" method="post" action="job_save.php" onsubmit="return cfm_job();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			<td width="25%" height="40" align="right">招聘类别：</td>
			<td width="75%">
				<select name="type" id="type">
                	<option value="1" <?php if($row['type'] == 1){ echo 'selected="selected"';}?>>社会招聘</option>
                    <option value="2" <?php if($row['type'] == 2){ echo 'selected="selected"';}?>>校园招聘</option>
                <select>
        ...
        <tr>
			<td height="40" align="right">招聘部门：</td>
			<td><input type="text" name="department" id="department" class="input" value="<?php echo $row['department']; ?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td height="304" align="right">岗位职责：</td>
        ...
        <tr>
			<td height="304" align="right">其他要求：</td>
			<td><textarea name="ps" id="ps"><?php echo $row['ps']; ?></textarea>
				<script>
				var editor;
				KindEditor.ready(function(K) {
					editor = K.create('textarea[name="ps"]', {
						allowFileManager : true,
						width:'667px',
						height:'280px',
						extraFileUploadParams : {
