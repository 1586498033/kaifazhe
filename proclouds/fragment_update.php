...
<form name="form" id="form" method="post" action="fragment_save.php" onsubmit="return cfm_fragment();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
        ...
        <tr>
			<td width="25%" height="40" align="right">中文标识：</td>
			<td width="75%"><input type="text" name="ctitle" id="ctitle" class="input" value="<?php echo $row['ctitle']; ?>" /></td>
		</tr>
		<tr>
			<td width="25%" height="40" align="right">英文标识：</td>
			<td width="75%"><input type="text" name="etitle" id="etitle" class="input" value="<?php echo $row['etitle']; ?>" /></td>
		</tr>
		<tr>
        ...
        <tr>
			<td height="104" align="right">英文内容：</td>
			<td><textarea name="econtent" id="econtent" class="textdesc"><?php echo preg_replace("/<(.*?)>/","",$row['econtent']); ?></textarea></td>
		</tr>
		<tr class="nb">
