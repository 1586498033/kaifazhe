...
<body>
<div class="formHeader"> <span class="title">添加案例</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="infoimg_save.php" onsubmit="return cfm_infolm();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td><input type="text" name="stitle" id="stitle" class="input" />
				<span class="maroon">*</span>
				<div class="titlePanel">
					<input type="hidden" name="colorval" id="colorval" />
					<input type="hidden" name="boldval" id="boldval" />
		...
		<tr class="nb">
			...
			{
				echo '<span><input type="checkbox" name="type[]" id="type[]" value="'.$row['typename'].'" />['.$row['type'].']</span>';
			}
			?>
			</td>
		</tr>
		...
		<tr class="nb">
			...
			while($row = $dosql->GetArray())
			{
				echo '<span><input type="checkbox" name="tag[]" id="tag[]" value="'.$row['id'].'" />'.$row['tag'].'</span>';
			}
			?></td>
		</tr>
		<tr class="nb">
		...
		<tr>
			...
			<td><input type="text" name="case_img" id="case_img" class="input" />
		...
		<tr>
			...
			<td><input type="text" name="case_bimg" id="case_bimg" class="input" />
		...
		<tr>
			...
			<td>
				<input type="text" name="case_video" id="case_video" class="input" />
				<span class="cnote">
