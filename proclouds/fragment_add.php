...
<form name="form" id="form" method="post" action="fragment_save.php" onsubmit="return cfm_fragment();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
        ...
        <tr>
			...
			<td width="75%"><input type="text" name="ctitle" id="ctitle" class="input" /></td>
		</tr>
		<tr>
			<td width="25%" height="40" align="right">英文标识：</td>
			<td width="75%"><input type="text" name="etitle" id="etitle" class="input" /></td>
		</tr>
		<tr>
        ...
        <tr>
			...
			<td><textarea name="econtent" id="econtent" class="textdesc"></textarea></td>
		</tr>
		<tr class="nb">
