...
<form name="form" id="form" method="post" action="infolist_save.php" onsubmit="return cfm_infolm();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			<td width="10%" height="40" align="right">栏　目：</td>
			<td width="90%"><select name="classid" id="classid">
		...
		<tr>
			<td height="340" align="right" width="20%">详细内容：</td>
			<td width="80%"><textarea name="content" id="content" class="kindeditor"><?php echo $row['content']; ?></textarea>
				<script>
				var editor;
