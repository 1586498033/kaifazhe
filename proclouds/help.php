...
<div class="author">
	<h2>作者语</h2>
	<div class="hr_10"></div>
	<p>　ProCloud 前台与后台完全采用PHP代码开发完成。ProCloud 主要面向的开发者就是企业建站行业的同学们。我们需要的是简单的，快速的，稳定的，拆分性较强的CMS。可能每个站只有几个栏目，亦或网站功能较为特殊需要定制。所以，对模块化要求极强。因此，我们总结上述几点是企业建站开发者们最需要的几点需求，以此为突破口，开发过程中时刻遵循于此。我们希望，开发者在开发的过程中感觉快速、舒适，这是我们的追求。</p>
	<div class="hr_10"></div>
	<p>　　ProCloud 从2010年开发至今已有4年时间，其间已经过4次重写。结构，代码写法逐步成熟。系统内置多个类以及函数，大幅提升开发速度。如目前对系统类使用不惯得同学们，也可以采用PHP内置原生函数开发。每个前台页面保证在头部调用 '/include/config.inc.php' 即可初始化系统代码，进行开发工作。前台只作为示例展示，与后台关联程度不高，但也可直接使用。目前您可视ProCloud为一款CMS核心，在它之上制作丰富的网站。</p>
	<div class="hr_10"></div>
	<p>　　更多关于我们的信息可访问 <a href="javascript:;" target="_blank">ProCloud</a></p>
</div>
<div class="footer">© <?php echo date("Y");?> ProCloud</div>
</body>
</html>