...
<body>
<div class="formHeader"> <span class="title">添加用户</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<form name="form" id="form" method="post" action="message_save.php" onsubmit="return cfm_msg();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		<tr>
			...
			<td width="75%"><input type="text" name="name" id="name" class="input" />
		...
		<tr>
			...
			<td><input type="text" name="qq" id="qq" class="input" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td height="198" align="right">备注内容：</td>
